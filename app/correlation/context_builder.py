...
def _inventory_field_format_instruction(intent: str) -> str:
...
def _cloud_format_instruction() -> str:
    return """
...
"""
        ...
        format_instruction = _inventory_field_format_instruction(intent)
    elif intent == "cloud":
        format_instruction = _cloud_format_instruction()
    else:
        format_instruction = """
